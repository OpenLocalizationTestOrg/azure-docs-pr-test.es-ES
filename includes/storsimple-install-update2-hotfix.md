...
3. En el cuadro de búsqueda de Hola de hello catálogo de Microsoft Update, escriba el número de Knowledge Base (KB) de Hola de revisión de Hola que desee toodownload, por ejemplo **3121901**y, a continuación, haga clic en **búsqueda**.
   
    Hello revisión aparece listado, por ejemplo, **acumulativa 2.0 de actualización de agrupación de Software para StorSimple 8000 Series**.
...
5. Busque las revisiones adicionales enumerados en la tabla Hola anterior (**3121900**, **3080728**, **3090322**, y **3121899**) y agregue cada uno en el caso de la cesta de compras de Hola.
...
6. Después de software de hello actualización es completa, repita los pasos 3 a 5 tooinstall y monitor Hola agente SaaS y MDS. Asegúrese de que `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` se instala antes que `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Compruebe que las versiones de software de sistema de Hola. Escriba:
...
8. Repita los pasos 3 a 5 tooinstall Hola restantes revisiones de modo normal.
   
   * Hola controlador LSI - KB3121900
   * Hola Storport update - KB3080728
   * Hola actualización Spaceport - KB3090322
