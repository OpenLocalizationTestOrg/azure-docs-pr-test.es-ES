| **Método/modelo de implementación** | **Portal de Azure** | **Portal clásico** | **PowerShell** | **CLI** |
| --- | --- | --- | --- | --- |
...
(+) indica que este método de implementación solo está disponible para las redes virtuales en hello misma suscripción.<br>
