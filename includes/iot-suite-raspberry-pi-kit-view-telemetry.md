...
- Elija **Invocar método**. Hola LED conectado toohello que frambuesa Pi parpadea varias veces. aplicación de Hello en hello frambuesa Pi envía un panel de solución de toohello espera de confirmación:
