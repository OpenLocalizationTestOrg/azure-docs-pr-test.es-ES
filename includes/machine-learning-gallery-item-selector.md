<span data-ttu-id="b2842-101">La **[Galería de Cortana Intelligence](http://gallery.cortanaintelligence.com)** es un sitio administrado por la comunidad cuyo fin es descubrir y compartir soluciones creadas con Cortana Intelligence Suite.</span><span class="sxs-lookup"><span data-stu-id="b2842-101">**[Cortana Intelligence Gallery](http://gallery.cortanaintelligence.com)** is a community-driven site for discovering and sharing solutions built with Cortana Intelligence Suite.</span></span>
<span data-ttu-id="b2842-102">Hola Galería presenta una variedad de recursos que puede utilizar toodevelop sus propias soluciones de análisis.</span><span class="sxs-lookup"><span data-stu-id="b2842-102">hello Gallery has a variety of resources that you can use toodevelop your own analytics solutions.</span></span>
