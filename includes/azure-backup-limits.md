Hola siguiendo los límites aplica tooAzure copia de seguridad.
...
| Discos de datos adjunta tooan máquina virtual de Azure para copia de seguridad |16 |

* <sup>1</sup>límite de hello de 54400 GB no aplica tooIaaS copia de seguridad de máquina virtual.
