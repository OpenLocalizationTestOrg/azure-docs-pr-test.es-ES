...
### [Migrar too.NET 2.0](key-vault-dotnet2api-release-notes.md)
### Introducciones
...
### [Cómo toouse el almacén de claves soft-delete con CLI](key-vault-soft-delete-cli.md)
### [Cómo toouse el almacén de claves soft-delete con PowerShell](key-vault-soft-delete-powershell.md)
### [Use el acceso de toogrant de grupos](key-vault-group-permissions-for-apps.md)
...
## [CLI de Azure 2](/cli/azure/keyvault)
