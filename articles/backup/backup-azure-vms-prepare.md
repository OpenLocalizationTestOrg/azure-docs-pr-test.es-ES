...
> [!NOTE]
> No hay ninguna recomendación que deba usarse para el software de proxy. Asegúrese de que selecciona un proxy que tenga permanencia de salida y que sea compatible con los pasos de configuración que se indican a continuación. Asegúrese de que los programas de software de terceros no modifican la configuración del proxy
>
>
