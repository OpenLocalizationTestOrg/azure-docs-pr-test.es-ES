...
4. Conecte el disco del sistema operativo y los discos de datos. Según la configuración de las máquinas virtuales, haga clic en el vínculo correspondiente para ver los cmdlets correspondientes: 
