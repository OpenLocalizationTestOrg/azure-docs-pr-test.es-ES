...
El proveedor de condiciones se aplica al administrador de servicios y a los proveedores delegados. Administradores de servicios y proveedores de delegado pueden usar la API de uso del proveedor para ver el uso de sus inquilinos directa. Por ejemplo, P0 puede llamar a la API de proveedores para obtener información del uso directo de P1 y de P2, y P1 puede llamarla para obtener información de uso sobre P3 y P4.
