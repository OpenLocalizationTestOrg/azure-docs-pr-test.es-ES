...
7. Opcionalmente, establezca los valores siguientes:
    ...
    - **Servidor horario**: este campo define la hora del servidor y debe ser una dirección IP necesarios. Para buscar un servidor horario de dirección IP, visite [pool.ntp.org](http:\\pool.ntp.org) o hacer ping time.windows.com. 
...
2. Haga clic en **Default Domain Policy** y haga clic en **editar**.
...
5. En el **vigencia máxima de la contraseña propiedades** cuadro de diálogo, cambie el **contraseña expirará en** valor a 180, a continuación, haga clic en **Aceptar**.
