...
# <a name="task-complete-event"></a>Evento de tarea completada
 ...
 Este evento se genera cuando se haya completado una tarea, independientemente del código de salida de hello. Este evento puede ser usado toodetermine Hola duración de una tarea, donde se ejecutó la tarea hello, y si se vuelve a intentar.


 Hello en el ejemplo siguiente se muestra hello cuerpo de un evento complete la tarea.
