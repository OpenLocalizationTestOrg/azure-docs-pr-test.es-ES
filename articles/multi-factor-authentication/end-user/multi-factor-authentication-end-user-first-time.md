...
Cuando el departamento de TI requiere toostart mediante la verificación en dos pasos, verá una pantalla que dice **su administrador necesita que configure esta cuenta para la comprobación de seguridad adicional**:
...
10. En este momento, son solicitada tooset las contraseñas de aplicaciones para aplicaciones que no son de explorador como Outlook 2010 o anterior, o una aplicación de correo electrónico nativo de hello en dispositivos de Apple. Esto es porque algunas aplicaciones no admiten la comprobación en dos pasos. Si no se utilizan estas aplicaciones, haga clic en **realiza** y omitir el resto de Hola de pasos de Hola.
