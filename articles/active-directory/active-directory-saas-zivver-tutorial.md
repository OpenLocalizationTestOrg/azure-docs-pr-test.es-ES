...
En este tutorial, aprenderá cómo toointegrate ZIVVER con Azure Active Directory (Azure AD).

Integración ZIVVER con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooZIVVER.
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooZIVVER (Single Sign-On) con sus cuentas de Azure AD.
...
integración de Azure AD con ZIVVER tooconfigure, necesita Hola siguientes elementos:
...
1. Agregar ZIVVER desde la Galería de Hola
2. Configuración y comprobación del inicio de sesión único de Azure AD

## <a name="adding-zivver-from-hello-gallery"></a>Agregar ZIVVER desde la Galería de Hola
integración de hello tooconfigure de ZIVVER en Azure AD, deberá tooadd ZIVVER de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd ZIVVER de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **ZIVVER**, seleccione **ZIVVER** desde el panel de resultados, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en ZIVVER es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en ZIVVER debe toobe establecido.

En ZIVVER, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con ZIVVER, deberá hello toocomplete después de bloques de creación:
...
3. **[Crear un usuario de prueba ZIVVER](#create-a-zivver-test-user)**  -toohave un equivalente de Britta Simon en ZIVVER que es la representación toohello vinculado Azure AD del usuario.
...
En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en la aplicación ZIVVER.

**inicio de sesión único en Azure AD tooconfigure con ZIVVER, realizar Hola pasos:**

1. En el portal de Azure, en Hola Hola **ZIVVER** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En hello **ZIVVER dominio y las direcciones URL** sección, lleve a cabo Hola pasos:
    ...
    Hola **identificador** cuadro de texto, escriba la dirección URL hello:`https://app.zivver.com/SAML/Zivver`
...
6. tooconfigure inicio de sesión único en **ZIVVER** lado, necesita hello toosend descargado **Metadata XML** demasiado[equipo de soporte técnico ZIVVER](https://support.zivver.com). Establecen esta Hola de toohave configuración configurada correctamente en ambos lados de la conexión de SSO de SAML.
...
En esta sección, creará un usuario llamado Britta Simon en ZIVVER. Trabajar con [equipo de soporte técnico ZIVVER](https://support.zivver.com) a los usuarios de tooadd hello en la plataforma ZIVVER Hola.

### <a name="assign-hello-azure-ad-test-user"></a>Asignar el usuario de prueba de hello Azure AD

En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooZIVVER.

![Asigne el rol de usuario de Hola][200] 

**tooassign Britta Simon tooZIVVER, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **ZIVVER**.
...
Al hacer clic en hello ZIVVER el icono Panel de acceso de hello, deberá obtener la aplicación de ZIVVER tooyour automáticamente ha iniciado sesión.
