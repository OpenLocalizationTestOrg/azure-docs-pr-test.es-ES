...
Cuando una aplicación se registra con Azure AD, el desarrollador de aplicaciones de Hola registra información relacionada con la federación con Azure AD. Esto incluye hello **URI de redireccionamiento** y **Metadata URI** de aplicación hello.

Azure AD usa hello **Metadata URI** de Hola Hola del tooretrieve del servicio de nube firma hello y clave de cierre de sesión URI del servicio de nube de Hola. Si la aplicación hello no admite un URI de metadatos, desarrollador Hola debe ponerse en contacto con Microsoft soporte tooprovide Hola logout URI y clave de firma.
