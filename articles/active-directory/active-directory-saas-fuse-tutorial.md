...
En este tutorial, aprenderá cómo toointegrate fusible con Azure Active Directory (Azure AD).

Integración fusible con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooFuse.
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooFuse (Single Sign-On) con sus cuentas de Azure AD.
...
integración de Azure AD tooconfigure con fusible, necesita Hola siguientes elementos:
...
1. Agregar fusible de galería de Hola
2. Configuración y prueba del inicio de sesión único en Azure AD

## <a name="add-fuse-from-hello-gallery"></a>Agregar fusible de galería de Hola
integración de hello tooconfigure de fusible en Azure AD, deberá tooadd fusible de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd fusible de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **fusible**, seleccione **fusible** desde el panel de resultados, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en fusible es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en fusible necesidades toobe establecido.

En fusible, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con fusible, deberá hello toocomplete después de bloques de creación:
...
3. **[Crear un usuario de prueba fusible](#create-a-fuse-test-user)**  -toohave un equivalente de Britta Simon en fusible que es la representación toohello vinculado Azure AD del usuario.
...
En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en la aplicación fusible.

**tooconfigure inicio de sesión único en Azure AD con fusible, lleve a cabo Hola pasos:**

1. En el portal de Azure, en Hola Hola **fusible** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En hello **fusible dominio y las direcciones URL** sección, lleve a cabo Hola pasos:
    ...
    Hola **dirección URL de inicio de sesión** cuadro de texto, escriba una dirección URL usando Hola siguiente patrón:`https://<tenant name>.fusion-universal.com/`

    > [!NOTE] 
    > Este valor no es real. Actualice este valor con hello dirección URL de inicio de sesión real. Póngase en contacto con [equipo de soporte técnico de cliente fusible](mailto:support@fusion-universal.com) tooget este valor. 
...
6. En hello **configuración fusible** sección, haga clic en **configurar fusible** tooopen **configurar inicio de sesión** ventana. Hola copia **dirección URL de cierre de sesión, Id. de entidad de SAML y SAML Single Sign-On dirección URL del servicio** de hello **sección de referencia rápida.**

    ![Configuración de Fuse](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_configure.png) 

7. tooget SSO configurado para la aplicación, póngase en contacto con [equipo de soporte técnico de fusible](mailto:support@fusion-universal.com) y proporcionarles siguiente hello:

    * Hola descargado **archivo de certificado (Raw)**
...
En esta sección, creará un usuario llamado Britta Simon en Fuse. Trabaje con [equipo de soporte técnico de fusible](mailto:support@fusion-universal.com) a los usuarios de tooadd hello en la plataforma de fusible Hola.


### <a name="assign-hello-azure-ad-test-user"></a>Asignar el usuario de prueba de hello Azure AD

En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooFuse.

![Asigne el rol de usuario de Hola][200] 

**tooassign Britta Simon tooFuse, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **fusible**.
...
Al hacer clic en icono de fusible Hola Hola Panel de acceso, deberá obtener automáticamente ha iniciado sesión tooyour fusible aplicación.
