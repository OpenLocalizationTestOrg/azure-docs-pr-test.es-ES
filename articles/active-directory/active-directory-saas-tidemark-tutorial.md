...
En este tutorial, aprenderá cómo toointegrate Tidemark con Azure Active Directory (Azure AD).

Integración Tidemark con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooTidemark
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooTidemark (Single Sign-On) con sus cuentas de Azure AD
...
integración de Azure AD con Tidemark tooconfigure, necesita Hola siguientes elementos:
...
1. Agregar Tidemark desde la Galería de Hola
2. Configuración y comprobación del inicio de sesión único de Azure AD

## <a name="adding-tidemark-from-hello-gallery"></a>Agregar Tidemark desde la Galería de Hola
integración de hello tooconfigure de Tidemark en Azure AD, deberá tooadd Tidemark de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd Tidemark de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **Tidemark**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-tidemark-tutorial/tutorial_tidemark_search.png)

5. En el panel de resultados de hello, seleccione **Tidemark**y, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en Tidemark es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en Tidemark debe toobe establecido.

En Tidemark, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con Tidemark, deberá hello toocomplete después de bloques de creación:

1. **[Configuración de Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable la toouse usuarios esta característica.
2. **[Crear un usuario de prueba de Azure AD](#creating-an-azure-ad-test-user)**  -inicio de sesión único en Azure AD tootest con Britta Simon.
3. **[Crear un usuario de prueba Tidemark](#creating-a-tidemark-test-user)**  -toohave un equivalente de Britta Simon en Tidemark que es la representación toohello vinculado Azure AD del usuario.
4. **[Asignar usuario de prueba de hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD inicio de sesión único.
5. **[Pruebas de Single Sign-On](#testing-single-sign-on)**  -tooverify Hola si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en la aplicación Tidemark.

**inicio de sesión único en Azure AD tooconfigure con Tidemark, realizar Hola pasos:**

1. En el portal de Azure, en Hola Hola **Tidemark** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En hello **Tidemark dominio y las direcciones URL** sección, lleve a cabo Hola pasos:
    ...
    > [!NOTE] 
    > Estos valores no son reales. Actualizar estos valores con hello real de dirección URL de inicio de sesión y el identificador. Póngase en contacto con [equipo de soporte técnico de cliente de Tidemark](http://www.tidemark.com/contact-us) tooget estos valores. 
...
6. En hello **Tidemark configuración** sección, haga clic en **configurar Tidemark** tooopen **configurar inicio de sesión** ventana. Hola copia **dirección URL de cierre de sesión, Id. de entidad de SAML y SAML Single Sign-On dirección URL del servicio** de hello **sección de referencia rápida.**

    ![Configurar inicio de sesión único](./media/active-directory-saas-tidemark-tutorial/tutorial_tidemark_configure.png) 

7. inicio de sesión único en tooconfigure en **Tidemark** lado, necesita hello toosend descargado **Certificate(Base64), Id. de entidad de SAML, URL de cierre de sesión y SAML Single Sign-On dirección URL del servicio** demasiado[Tidemark equipo de soporte técnico](http://www.tidemark.com/contact-us). Establecen esta Hola de toohave configuración configurada correctamente en ambos lados de la conexión de SSO de SAML.
...
objetivo de Hola de esta sección es un usuario llamado a Britta Simon en Tidemark toocreate. Trabaje con [equipo de soporte técnico de Tidemark](http://www.tidemark.com/contact-us) a los usuarios de tooadd Hola Hola cuenta Tidemark. 

### <a name="assigning-hello-azure-ad-test-user"></a>Asignación de usuario de prueba de hello Azure AD

En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooTidemark.

![Asignar usuario][200] 

**tooassign Britta Simon tooTidemark, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **Tidemark**.
...
Al hacer clic en icono de Tidemark Hola Hola Panel de acceso, deberá obtener la aplicación de Tidemark tooyour automáticamente ha iniciado sesión.
