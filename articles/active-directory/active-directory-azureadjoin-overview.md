...
| --- | --- | --- |
| Los usuarios pueden iniciar sesión en Windows con las credenciales de trabajo (como lo hacen hoy). |Los usuarios pueden iniciar sesión en Windows con las credenciales de trabajo que se administran en Azure AD. Esto es importante para los dispositivos corporativos en tres casos: <ol><li>La organización no tiene Active Directory local (por ejemplo, una pequeña empresa).</li><li>La organización no crea todas las cuentas de usuario en Active Directory (por ejemplo, las cuentas de estudiantes, consultores o trabajadores estacionales no se crean en Active Directory).</li><li>La organización tiene dispositivos de la empresa que no se pueden unir a un dominio (local), como los teléfonos o tabletas con una SKU móvil (por ejemplo, un dispositivo secundario llevado a una fábrica o tienda).</li></ol> Azure AD Join permite unir dispositivos de la empresa para organizaciones administradas y federadas. |Los usuarios inician sesión en Windows con las credenciales de su cuenta de Microsoft personal (sin cambios). |
