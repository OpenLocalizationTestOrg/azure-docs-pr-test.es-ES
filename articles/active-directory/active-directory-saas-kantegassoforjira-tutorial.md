...
En este tutorial, aprenderá cómo toointegrate Kantega SSO para JIRA con Azure Active Directory (Azure AD).

Integración Kantega SSO para JIRA con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooKantega SSO para JIRA
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooKantega SSO para JIRA (Single Sign-On) con sus cuentas de Azure AD
...
integración de Azure AD con Kantega SSO para JIRA tooconfigure, necesita Hola siguientes elementos:
...
1. Agregar Kantega SSO para JIRA desde la Galería de Hola
2. Configuración y comprobación del inicio de sesión único de Azure AD

## <a name="adding-kantega-sso-for-jira-from-hello-gallery"></a>Agregar Kantega SSO para JIRA desde la Galería de Hola
integración de hello tooconfigure de Kantega SSO para JIRA en Azure AD, necesitará tooadd Kantega SSO para JIRA de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd Kantega SSO para JIRA de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **Kantega SSO para JIRA**.
...
5. En el panel de resultados de hello, seleccione **Kantega SSO para JIRA**y, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en Kantega SSO para JIRA es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en Kantega SSO para JIRA debe toobe establecido.

En Kantega SSO para JIRA, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con Kantega SSO para JIRA, deberá hello toocomplete después de bloques de creación:

1. **[Configuración de Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)**  -tooenable la toouse usuarios esta característica.
2. **[Crear un usuario de prueba de Azure AD](#creating-an-azure-ad-test-user)**  -inicio de sesión único en Azure AD tootest con Britta Simon.
3. **[Crear un SSO Kantega de usuario de prueba JIRA](#creating-a-kantega-sso-for-jira-test-user)**  -toohave un equivalente de Britta Simon en Kantega SSO para JIRA que es la representación toohello vinculado Azure AD del usuario.
4. **[Asignar usuario de prueba de hello Azure AD](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD inicio de sesión único.
5. **[Pruebas de Single Sign-On](#testing-single-sign-on)**  -tooverify Hola si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en el SSO Kantega para aplicaciones de JIRA.

**tooconfigure inicio de sesión único en Azure AD con Kantega SSO para JIRA, lleve a cabo Hola pasos:**

1. En el portal de Azure, en Hola Hola **Kantega SSO para JIRA** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En **IDP** inicia el modo, hello **Kantega SSO de dominio JIRA y direcciones URL** sección realizar Hola siguiendo el paso:
...
4. En **SP** modo iniciado, verificación **mostrar avanzadas de configuración de la URL** y realizar Hola siguiendo el paso:
    ...
    > [!NOTE] 
    > Estos valores no son reales. Actualizar estos valores con hello real identificador, dirección URL de respuesta y dirección URL de inicio de sesión. Estos valores se reciben durante la configuración de Hola de complemento de Jira, que se explica más adelante en el tutorial Hola.
...
7. En una ventana del explorador web diferente, inicie sesión en tooyour JIRA en el servidor local como administrador.
...
9. En la sección de la pestaña Complementos, haga clic en **Find new add-ons** (Buscar nuevos complementos). Búsqueda **Kantega SSO para JIRA (SAML & Kerberos)** y haga clic en **instalar** tooinstall botón Hola nuevo complemento SAML.
...
13. El nuevo complemento aparece en **INTEGRACIONES**. Haga clic en **configurar** tooconfigure Hola nuevo complemento.
...
16. En hello **propiedades de la aplicación** sección, realice los siguientes pasos: 
    ...
    a. Hola copia **App ID URI** valor y utilizarlo como **identificador, dirección URL de respuesta y dirección URL de inicio de sesión** en hello **Kantega SSO de dominio JIRA y direcciones URL** sección en el portal de Azure.
...
20. En hello **cuentas de usuario JIRA** sección, realice los siguientes pasos:

    ![Configurar inicio de sesión único](./media/active-directory-saas-kantegassoforjira-tutorial/addon10.png)

    a. Seleccione **crear usuarios en el directorio interno del JIRA si es necesario** y escriba nombre adecuado Hola del grupo de Hola para los usuarios (puede ser no varios. de grupos separados por coma).
...
toolog de los usuarios de Azure AD tooenable en tooJIRA, se les deben aprovisionar en JIRA. En Kantega SSO for JIRA, el aprovisionamiento es una tarea manual.

**tooprovision una cuenta de usuario, lleve a cabo Hola pasos:**

1. Inicie sesión en tooyour JIRA en el servidor local como administrador.
...
4. En hello **"Crear nuevo usuario"** cuadro de diálogo, siga los pasos de hello:
...
En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooKantega SSO para JIRA.

![Asignar usuario][200] 

**tooassign Britta Simon tooKantega SSO para JIRA, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **Kantega SSO para JIRA**.
...
Al hacer clic en hello Kantega SSO de icono JIRA Hola Panel de acceso, obtendrá automáticamente ha iniciado sesión tooyour Kantega SSO para aplicaciones de JIRA.
