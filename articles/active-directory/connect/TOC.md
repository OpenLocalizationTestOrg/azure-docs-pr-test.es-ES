...
### [Cambiar la configuración predeterminada de Hola](active-directory-aadconnectsync-best-practices-changing-default-configuration.md)
...
### [Cambio de contraseña de cuenta de servicio de sincronización de Azure AD Hola](active-directory-aadconnectsync-change-serviceacct-pass.md)
### [Cambiar la contraseña de la cuenta de hello AD DS](active-directory-aadconnectsync-change-addsacct-pass.md)
...
### [¿Cómo toorecover de límite de 10 GB de LocalDB](active-directory-aadconnect-recover-from-localdb-10gb-limit.md)
...
### [Atributos sincronizados tooAzure Active Directory](active-directory-aadconnectsync-attributes-synchronized.md)
...
# Temas relacionados
## [Supervisar los servicios de infraestructura y la sincronización de identidad local en la nube de Hola](../connect-health/active-directory-aadconnect-health.md)
