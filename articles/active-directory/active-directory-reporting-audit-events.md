...
Para la información más reciente sobre retención, consulte las [directivas de retención de informes de Azure Active Directory](active-directory-reporting-retention.md).
