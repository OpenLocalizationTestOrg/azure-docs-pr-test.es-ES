...
A continuación se muestra una introducción de alto nivel de hello pasos necesarios tooconfigure federado inicio de sesión único para una galería-no (p. ej., personalizado) aplicación.

-   [Configurar valores de metadatos de la aplicación hello en Azure AD (inicio de sesión en la dirección URL de respuesta de dirección URL, identificador)](#_Configuring_single_sign-on)
...
-   [Configurar los valores de metadatos de Azure AD de la aplicación hello (inicio de sesión en la dirección URL, emisor, dirección URL de cierre de sesión y certificado)](#_Configuring_single_sign-on)

-   [Asignar a usuarios de aplicación toohello](#_Assign_users_to_the_application)

## <a name="configuring-single-sign-on-toonon-gallery-applications"></a>Configuración de aplicaciones único inicio de sesión toonon-Galería
...
15. [Asignar a usuarios de aplicación de toohello.](#assign-users-to-the-application)
