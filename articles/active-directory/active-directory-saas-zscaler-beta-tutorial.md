...
En este tutorial, aprenderá cómo toointegrate Zscaler Beta con Azure Active Directory (Azure AD).

Integración de Zscaler Beta con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooZscaler Beta
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooZscaler Beta (inicio de sesión único) con sus cuentas de Azure AD
...
tooconfigure integración de Azure AD con Zscaler Beta, necesita Hola siguientes elementos:
...
1. Agregar Zscaler Beta de galería de Hola
2. Configuración y comprobación del inicio de sesión único de Azure AD

## <a name="adding-zscaler-beta-from-hello-gallery"></a>Agregar Zscaler Beta de galería de Hola
integración de hello tooconfigure de Zscaler Beta en Azure AD, deberá tooadd Zscaler Beta de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd Zscaler Beta de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **Zscaler Beta**.
...
5. En el panel de resultados de hello, seleccione **Zscaler Beta**y, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en Zscaler Beta es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en Zscaler Beta debe toobe establecido.

En Zscaler Beta, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con Zscaler Beta, deberá hello toocomplete después de bloques de creación:
...
4. **[Crear un usuario de prueba de Zscaler Beta](#creating-a-zscaler-beta-test-user)**  -toohave un equivalente de Britta Simon en Zscaler Beta que es la representación toohello vinculado Azure AD del usuario.
...
En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en la aplicación de Zscaler Beta.

**inicio de sesión único en tooconfigure Azure AD con Zscaler Beta, siga Hola pasos:**

1. En el portal de Azure, en Hola Hola **Zscaler Beta** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En hello **Zscaler Beta dominio y las direcciones URL** sección, lleve a cabo Hola pasos:

    ![Configurar inicio de sesión único](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)

    En cuadro de texto de dirección URL de hello inicio de sesión, escriba dirección URL de hello utilizada por los usuarios en toosign tooyour aplicación de Zscaler Beta.

    > [!NOTE] 
    > Tiene este valor con hello tooupdate dirección URL de inicio de sesión real. Póngase en contacto con [equipo de soporte técnico de Zscaler Beta cliente](https://www.zscaler.com/company/contact) tooget este valor. 
...
6. En hello **Zscaler Beta configuración** sección, haga clic en **configurar Zscaler Beta** tooopen **configurar inicio de sesión** ventana. Hola copia **SAML Single Sign-On dirección URL del servicio** de hello **sección de referencia rápida.**

    ![Configurar inicio de sesión único](./media/active-directory-saas-zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 

7. En una ventana del explorador web diferente, inicie sesión en tooyour sitio de empresa de Zscaler Beta como administrador.
...
9. En **Manage Administrators & Roles (Administrar administradores y roles)** haga clic en **Manage Users & Authentication (Administrar usuarios y autenticación)**.   
    ...
    ![Administración de usuarios y autenticación](./media/active-directory-saas-zscaler-beta-tutorial/ic800207.png "Administración de usuarios y autenticación")
...
5. En la sección servidor Proxy hello, realizar Hola pasos:   
    ...
    b. En el cuadro de texto de dirección de hello, escriba **gateway.zscalerbeta.net**.
...
toolog de los usuarios de Azure AD tooenable en tooZscaler Beta, deben ser aprovisionado tooZscaler Beta. En caso de hello de Zscaler Beta, el aprovisionamiento es una tarea manual.
...
1. Inicie sesión en tooyour **Zscaler Beta** inquilino.
...
3. Haga clic en **User Management**(Administración de usuarios).   
     ...
     ![Agregar](./media/active-directory-saas-zscaler-beta-tutorial/ic781036.png "Agregar")
...
5. En la sección Agregar usuario hello, realizar Hola pasos:
    ...
    a. Hola de tipo **UserID**, **usuario DisplayName**, **contraseña**, **Confirmar contraseña**y, a continuación, seleccione **grupos**hello y **departamento** de un Azure válida que desee tooprovision de cuenta de AD.

    b. Haga clic en **Guardar**.

> [!NOTE]
> Puede usar cualquier otra Zscaler Beta usuario cuenta herramienta de creación o las API proporcionadas por Zscaler Beta tooprovision cuentas de usuario de Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Asignación de usuario de prueba de hello Azure AD

En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooZscaler Beta.

![Asignar usuario][200] 

**tooassign Britta Simon tooZscaler Beta, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **Zscaler Beta**.
...
Al hacer clic en hello Zscaler Beta disponer en mosaico en el Panel de acceso de hello, debería obtener automáticamente ha iniciado sesión tooyour aplicación de Zscaler Beta.
