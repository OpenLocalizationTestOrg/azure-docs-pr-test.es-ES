...
En este tutorial, aprenderá cómo toointegrate Zscaler One con Azure Active Directory (Azure AD).

Integración de Zscaler One con Azure AD proporciona Hola siguientes ventajas:

- Puede controlar en Azure AD que tenga acceso tooZscaler uno
- Puede habilitar los usuarios tooautomatically get ha iniciado sesión tooZscaler uno (Single Sign-On) con sus cuentas de Azure AD
...
tooconfigure integración de Azure AD con Zscaler One, necesita Hola siguientes elementos:
...
1. Agregar Zscaler One desde la Galería de Hola
2. Configuración y comprobación del inicio de sesión único de Azure AD

## <a name="adding-zscaler-one-from-hello-gallery"></a>Agregar Zscaler One desde la Galería de Hola
integración de hello tooconfigure de Zscaler One en Azure AD, deberá tooadd Zscaler One de lista de tooyour Hola Galería de aplicaciones administradas de SaaS.

**tooadd Zscaler One de galería de hello, lleve a cabo Hola pasos:**
...
4. En el cuadro de búsqueda de hello, escriba **Zscaler One**.
...
5. En el panel de resultados de hello, seleccione **Zscaler One**y, a continuación, haga clic en **agregar** botón aplicación hello de tooadd.
...
Para toowork de inicio de sesión único, Azure AD necesita tooknow qué usuario equivalente de hello en Zscaler One es tooa usuario en Azure AD. En otras palabras, una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de hello en Zscaler One debe toobe establecido.

En Zscaler One, asigne el valor de Hola de hello **nombre de usuario** en Azure AD como valor de Hola de hello **nombre de usuario** tooestablish la relación de vínculo de Hola.

tooconfigure y prueba de inicio de sesión único en Azure AD con Zscaler One, deberá hello toocomplete después de bloques de creación:
...
4. **[Crear un usuario de prueba Zscaler One](#creating-a-zscaler-one-test-user)**  -toohave un equivalente de Britta Simon en Zscaler One que es la representación toohello vinculado Azure AD del usuario.
...
En esta sección, habilitar inicio de sesión único en Azure AD en hello portal de Azure y configurar el inicio de sesión único en la aplicación de Zscaler One.

**inicio de sesión único en tooconfigure Azure AD con Zscaler One, siga Hola pasos:**

1. En el portal de Azure, en Hola Hola **Zscaler One** página de integración de aplicaciones, haga clic en **inicio de sesión único**.
...
3. En hello **Zscaler un dominio y las direcciones URL** sección, lleve a cabo Hola pasos:

    ![Configurar inicio de sesión único](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_url.png)

    En el cuadro de texto de dirección URL de inicio de sesión de hello, escriba dirección URL de hello utilizado por los usuarios en toosign tooyour Zscaler una aplicación.

    > [!NOTE] 
    > Tiene este valor con hello tooupdate dirección URL de inicio de sesión real. Póngase en contacto con [equipo de soporte técnico de Zscaler un cliente](https://www.zscaler.com/company/contact) tooget estos valores.
...
6. En hello **una configuración de Zscaler** sección, haga clic en **configurar Zscaler One** tooopen **configurar inicio de sesión** ventana. Hola copia **SAML Single Sign-On dirección URL del servicio** de hello **sección de referencia rápida.**

    ![Configurar inicio de sesión único](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. En una ventana del explorador web diferente, inicie sesión en el sitio de empresa de Zscaler One de tooyour como administrador.
...
toolog de los usuarios de Azure AD tooenable en tooZscaler uno, deben ser aprovisionado tooZscaler uno. En caso de hello de Zscaler One, el aprovisionamiento es una tarea manual.
...
1. Inicie sesión en tooyour **Zscaler One** inquilino.
...
> [!NOTE]
> Puede usar cualquier otra Zscaler One usuario cuenta herramienta de creación o las API proporcionadas por Zscaler One tooprovision cuentas de usuario de Azure AD.

### <a name="assigning-hello-azure-ad-test-user"></a>Asignación de usuario de prueba de hello Azure AD

En esta sección, se habilita Britta Simon toouse un inicio de sesión único Azure concediendo acceso tooZscaler uno.

![Asignar usuario][200] 

**tooassign tooZscaler Britta Simon uno, lleve a cabo Hola pasos:**

1. Hola portal de Azure, abra la vista de aplicaciones de hello y, a continuación, navegue a vista de directorio toohello y vaya demasiado**aplicaciones empresariales** , a continuación, haga clic en **todas las aplicaciones**.

    ![Asignar usuario][201] 

2. En la lista de aplicaciones de hello, seleccione **Zscaler One**.
...
Al hacer clic en icono Zscaler One Hola Hola Panel de acceso, deberá obtener la aplicación de Zscaler One tooyour automáticamente ha iniciado sesión.
