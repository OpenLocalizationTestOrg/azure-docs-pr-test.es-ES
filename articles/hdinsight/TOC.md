...
## [Inicio con Hive interactivo (versión preliminar)](hdinsight-hadoop-use-interactive-hive.md)
## [Inicio con Kafka (versión preliminar)](hdinsight-apache-kafka-get-started.md)
...
#### [Usar hello Hive vista](hdinsight-hadoop-use-hive-ambari-view.md)
...
#### [Usar herramientas de hello HDInsight para Visual Studio](hdinsight-hadoop-use-hive-visual-studio.md)
#### [Uso de Escritorio remoto](hdinsight-hadoop-use-hive-remote-desktop.md)
#### [Usar hello consola de consultas](hdinsight-hadoop-use-hive-query-console.md)
...
### [Ejecutar ejemplos de hello MapReduce](hdinsight-hadoop-run-samples-linux.md)
...
#### [Usar hello SDK para .NET](hdinsight-hadoop-use-pig-dotnet-sdk.md)
...
#### [Almacén de escritura tooData Lake](hdinsight-storm-write-data-lake-store.md)
...
### [Usar herramientas de HDInsight toocreate Spark aplicaciones](hdinsight-apache-spark-eclipse-tool-plugin.md)
### [Usar herramientas de HDInsight toodebug Spark aplicaciones remotamente a través de SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)
...
### [Conectar Excel tooHadoop](hdinsight-connect-excel-hive-odbc-driver.md)
### [Conectar con el controlador JDBC de Hive de Hola](hdinsight-connect-hive-jdbc-driver.md)
...
### [Conectar la red local de HDInsight tooyour](connect-on-premises-network.md)
...
#### [Usar REST tooinstall aplicaciones](https://msdn.microsoft.com/library/mt706515.aspx)
#### [Publicar aplicaciones de HDInsight tooAzure Marketplace](hdinsight-apps-publish-applications.md)
## Protección
...
### [Restringir el acceso toodata](hdinsight-storage-sharedaccesssignature-permissions.md)
## Administrar
...
#### [Usar cURL y Hola API de REST de Azure](hdinsight-hadoop-create-linux-clusters-curl-rest.md)
#### [Usar hello SDK para .NET](hdinsight-hadoop-create-linux-clusters-dotnet-sdk.md)
#### [Usar hello CLI de Azure](hdinsight-hadoop-create-linux-clusters-azure-cli.md)
#### [Usar hello portal de Azure](hdinsight-hadoop-create-linux-clusters-portal.md)
...
#### [Usar hello CLI de Azure](hdinsight-administer-use-command-line.md)
### [Administrar clústeres mediante la interfaz de usuario de web de hello Ambari](hdinsight-hadoop-manage-ambari.md)
...
### [Migrar las herramientas de desarrollo de tooResource Manager](hdinsight-hadoop-development-using-azure-resource-manager.md)
### [Disponibilidad y confiabilidad](hdinsight-high-availability-linux.md)
### [Actualizar la versión de toonewer de clúster de HDInsight](hdinsight-upgrade-cluster.md)
...
#### [Usar vistas de Ambari toodebug Tez trabajos](hdinsight-debug-ambari-tez-view.md)
...
### [Migrar clústeres de tooLinux de clústeres de Windows](hdinsight-migrate-from-windows-to-linux.md)
### [Migrar clústeres de tooLinux de soluciones de .NET](hdinsight-hadoop-migrate-dotnet-to-linux.md)
...
### [Use gráficos de Giraph tooprocess a gran escala](hdinsight-hadoop-giraph-install.md)
...
### [Usar aplicaciones de Java de Maven toobuild](hdinsight-hbase-build-java-maven.md)
### [Usar hello Tez UI toodebug Tez trabajos](hdinsight-debug-tez-ui.md)
...
### [Supervisar clústeres con hello Ambari API](hdinsight-monitor-use-ambari-api.md)

# Recursos
## [Azure Roadmap](https://azure.microsoft.com/roadmap/?category=intelligence-analytics)
## [Obtener ayuda en el foro de Hola](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=hdinsight)
