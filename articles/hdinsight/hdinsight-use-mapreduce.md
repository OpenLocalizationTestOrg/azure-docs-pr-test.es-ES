...
| [REST](hdinsight-hadoop-use-mapreduce-curl.md) |Enviar el trabajo de forma remota mediante **REST** (los ejemplos usan cURL) |Linux o Windows |Linux, Unix, Mac OS X o Windows |
