        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos de Logic Apps</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Esquemas</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Lenguaje de definición de flujo de trabajo</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Acciones y desencadenadores de flujo de trabajo</a></p>
                   </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/logic-apps/logic-apps-schema-2016-04-01">Disponibilidad general</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-schema-2015-08-01">Versión preliminar</a></p>
                   </div>
                </div>
            </div>
        </div>
