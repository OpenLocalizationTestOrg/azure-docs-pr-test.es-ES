...
### [Solución de problemas](logic-apps-diagnosing-failures.md)
...
### [Recuperación ante desastres](logic-apps-enterprise-integration-b2b-business-continuity.md)
...
### [Supervisión del estado de la aplicación lógica de OMS con Log Analytics](logic-apps-monitor-your-logic-apps-oms.md)
...
#### [Consulta de OMS para mensajes B2B](logic-apps-track-b2b-messages-omsportal-query-filter-control-number.md)
...
## Introducción
### [Creación de una aplicación sin servidor en Visual Studio](logic-apps-serverless-get-started-vs.md)
## Escenarios y tutoriales
### [Recopilación de comentarios de los clientes](logic-apps-scenario-social-serverless.md)
### [Envío de mensajes de correo electrónico automatizados](https://channel9.msdn.com/Blogs/Microsoft-Integration/Build-and-Deploy-Serverless-Part-1)
### [Procesamiento de pedidos B2B/EDI](logic-apps-enterprise-integration-overview.md)
...
### [Funciones de Azure](logic-apps-azure-functions.md)
...
### [Centros de eventos](../connectors/connectors-create-api-azure-event-hubs.md)
### [Sistema de archivos](logic-apps-using-file-connector.md)
### [Archivo plano](logic-apps-enterprise-integration-flatfile.md)
...
### [Cuenta de integración](logic-apps-enterprise-integration-metadata.md)
...
### [Solicitud y respuesta](../connectors/connectors-native-reqres.md)
### [Salesforce](../connectors/connectors-create-api-salesforce.md)
### [SAP](logic-apps-using-sap-connector.md)
### [Programación](../connectors/connectors-native-recurrence.md)
### [Bus de servicio](../connectors/connectors-create-api-servicebus.md)
