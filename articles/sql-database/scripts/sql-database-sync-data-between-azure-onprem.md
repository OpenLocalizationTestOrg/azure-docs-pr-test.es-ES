...
---
# <a name="use-powershell-toosync-between-an-azure-sql-database-and-a-sql-server-on-premises-database"></a>Usar PowerShell toosync entre una base de datos de SQL Azure y una base de datos de SQL Server local

En este ejemplo de PowerShell configura toosync de sincronización de datos entre una base de datos de SQL Azure y una base de datos de SQL Server local. 

Este ejemplo requiere hello Azure PowerShell versión 4.2 o posterior del módulo. Ejecutar `Get-Module -ListAvailable AzureRM` toofind versión de Hola instalado. Si necesita tooinstall o una actualización, consulte [módulo instalar Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/install-azurerm-ps).
...
Después de ejecutar script de ejemplo de Hola, puede ejecutar Hola después el grupo de recursos de comando tooremove hello y todos los recursos asociados con él.
...
| [New-AzureRmSqlSyncAgentKey](/powershell/module/azurerm.sql/New-AzureRmSqlSyncAgentKey) |  Genera la clave del agente Hola asociado con el agente de sincronización de Hola |
| [Get-AzureRmSqlSyncAgentLinkedDatabase](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncAgentLinkedDatabase) |  Obtener toda la información de Hola de hello agente de sincronización |
| [New-AzureRmSqlSyncMember](/powershell/module/azurerm.sql/New-AzureRmSqlSyncMember) |  Agregar un toohello miembro nuevo grupo de sincronización |
| [Update-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncSchema) |  Actualiza la información de esquema de base de datos de Hola |
| [Get-AzureRmSqlSyncSchema](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncSchem) |  Obtener información de esquema de base de datos de Hola |
| [Update-AzureRmSqlSyncGroup](/powershell/module/azurerm.sql/Update-AzureRmSqlSyncGroup) |  Las actualizaciones de Hola grupo de sincronización |
| [Start-AzureRmSqlSyncGroupSync](/powershell/module/azurerm.sql/Start-AzureRmSqlSyncGroupSync) | Desencadena una sincronización |
| [Get-AzureRmSqlSyncGroupLog](/powershell/module/azurerm.sql/Get-AzureRmSqlSyncGroupLog) |  Hola de comprobaciones de registro de sincronización |
|||
