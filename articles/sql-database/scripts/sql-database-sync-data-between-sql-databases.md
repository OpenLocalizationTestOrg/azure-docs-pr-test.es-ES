...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Usar PowerShell toosync entre varias bases de datos de SQL Azure
 
En este ejemplo de PowerShell configura toosync de sincronización de datos entre varias bases de datos de SQL Azure.
