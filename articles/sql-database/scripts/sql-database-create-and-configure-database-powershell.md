...
---
# <a name="use-powershell-toocreate-a-single-azure-sql-database-and-configure-a-firewall-rule"></a>Usar PowerShell toocreate una sola base de datos de SQL Azure y configurar una regla de firewall

Este ejemplo de script de PowerShell crea una instancia de Azure SQL Database y configura una regla de firewall en el nivel de servidor. Una vez que se ha ejecutado correctamente el script de Hola, base de datos SQL puede tener acceso desde todos los servicios de Azure de Hola y Hola configuran dirección IP. 
