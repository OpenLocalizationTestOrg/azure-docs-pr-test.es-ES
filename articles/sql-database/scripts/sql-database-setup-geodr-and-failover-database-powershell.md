...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-single-azure-sql-database"></a>Usar PowerShell tooconfigure replicación geográfica activa para una sola base de datos de SQL Azure

En este ejemplo de secuencia de comandos de PowerShell configura la replicación geográfica activa para una sola base de datos de SQL Azure y se conmuta por error tooa de réplica de base de datos de SQL Azure Hola.
