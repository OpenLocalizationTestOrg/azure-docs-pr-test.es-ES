...
---
# <a name="creating-web-apps-with-bottle-in-azure"></a>Creación de aplicaciones web con Bottle en Azure
Este tutorial describe cómo tooget comenzó a ejecutarse Python en aplicaciones de Web del servicio de aplicación de Azure. Aplicaciones web ofrece hospedaje gratuito limitado y una implementación rápida. Además, ahora también se puede usar Python. Medida que crezca su aplicación, puede cambiar toopaid de hospedaje y también se puede integrar con todos Hola otros servicios de Azure.

Se creará una aplicación web con el marco de trabajo de hello Bottle web (vea versiones alternativas de este tutorial para [Django](web-sites-python-create-deploy-django-app.md) y [matraz](web-sites-python-create-deploy-flask-app.md)). Se crear una aplicación web de Hola de hello Azure Marketplace, configurar la implementación de Git y clonar el repositorio de hello localmente. A continuación, que se ejecute la aplicación web de hello localmente, realizar cambios, confirmar e insertarlas demasiado[aplicaciones de Web del servicio de aplicación de Azure](http://go.microsoft.com/fwlink/?LinkId=529714). Hola tutorial se muestra cómo toodo de Windows o Mac y Linux.
...
* Git
* [Python Tools 2.2 para Visual Studio][Python Tools 2.2 para Visual Studio] (PTVS) - Nota: Opcional
...
## <a name="web-app-creation-on-hello-azure-portal"></a>Creación de aplicaciones Web en hello Portal de Azure
...
3. En los resultados de la búsqueda de hello, seleccione **Bottle**, a continuación, haga clic en **crear**.
4. Configurar aplicación de botella nuevo hello, como la creación de un nuevo plan de servicio de aplicaciones y un nuevo grupo de recursos para el mismo. A continuación, haga clic en **Crear**.
...
## <a name="web-app-development---windows---python-tools-for-visual-studio"></a>Web de desarrollo de aplicaciones - Windows - Herramientas de Python para Visual Studio
...
Asegúrese de que toouse Hola la misma versión de Python que está seleccionada para la aplicación web (en runtime.txt o hello hoja de configuración de la aplicación para la aplicación web en hello Portal de Azure)
...
Siga estos toolearn de vínculos más información acerca de la botella y Python Tools para Visual Studio: 
