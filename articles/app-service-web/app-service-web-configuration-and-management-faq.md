...
Si su sitio web está hospedado en App Service Environment para PowerApps, consulte [Direcciones de red de salida](app-service-app-service-environment-network-architecture-overview.md#outbound-network-addresses) para saber cómo obtener la dirección IP de salida.
...
Estamos trabajando para actualizar el Administrador de conexiones híbridas para corregir este problema. Si desea conocer soluciones alternativas, consulte [Hybrid Connections error with SQL Server: System.OverflowException: Arithmetic operation resulted in an overflow](https://blogs.msdn.microsoft.com/waws/2016/05/17/hybrid-connection-error-with-sql-server-system-overflowexception-arithmetic-operation-resulted-in-an-overflow/) (Error de conexiones híbridas con SQL Server: System.OverflowException: la operación aritmética ha provocado un desbordamiento).
...
Para más información, consulte [Creación de App Service Environment](app-service-web-how-to-create-an-app-service-environment.md).
...
Para obtener documentación detallada sobre la autenticación y la autorización en App Service, consulte [Seguridad de App Service](../app-service/app-service-security-readme.md). La documentación incluye también información acerca de la configuración de App Service para usar diversos inicios de sesión de proveedor de identidades:
