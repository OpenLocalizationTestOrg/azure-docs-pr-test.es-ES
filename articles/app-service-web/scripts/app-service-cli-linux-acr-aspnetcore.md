...
En este escenario, aprenderá cómo toocreate un grupo de recursos, aplicación de Linux plan y la aplicación web de servicio e implementar una aplicación de ASP.NET Core con un contenedor de Docker de hello del registro de contenedor de Azure.
...
| [az webapp config container set](https://docs.microsoft.com/cli/azure/webapp/config/container#set) | Establece el contenedor de Docker de hello para la aplicación web de Azure de hello. |
