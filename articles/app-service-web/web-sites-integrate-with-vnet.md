...
Este documento se centra principalmente en el uso de Azure Portal para Integración con red virtual. Para habilitar Integración con red virtual de una aplicación mediante PowerShell, siga las indicaciones que encontrará aquí: [Conexión de la aplicación a la red virtual con PowerShell][IntPowershell].
