...
Para obtener más información acerca de cómo hello toouse **CloudTable** de objetos, consulte [Introducción al almacenamiento de tabla de Azure mediante .NET](../storage/storage-dotnet-how-to-use-tables.md).
...
Para obtener información acerca de cómo el procesamiento de tabla toohandle desencadenada por un mensaje de la cola, o de trabajos Web escenarios SDK no procesar, consulte específica tootable [Introducción al almacenamiento de cola de Azure y Visual Studio conectado servicios (proyectos de trabajo Web) ](../storage/vs-storage-webjobs-getting-started-queues.md).
