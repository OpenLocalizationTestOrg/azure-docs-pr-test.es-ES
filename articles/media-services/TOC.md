...
## [Usar autenticación AAD tooaccess API](media-services-use-aad-auth-to-access-ams-api.md)
### [Usar autenticación AAD toomanage portal](media-services-portal-get-started-with-aad.md)
...
### [Use CLI toocreate y configure la aplicación AAD](media-services-cli-create-and-configure-aad-app.md)
### [Usar PowerShell toocreate y configurar la aplicación AAD](media-services-powershell-create-and-configure-aad-app.md)
...
#### [Use MES tooauto-generar una escalera de velocidad de bits](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Cómo miniaturas toogenerate utilizando Media Encoder estándar con .NET](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [Configurar la protección de contenido en el portal de Hola](media-services-portal-protect-content.md)
### [Configuración de la clave sin cifrado AES 128 bits para transmisiones](media-services-protect-with-aes128.md)
### [Usar REST tooencrypt su contenido con cifrado de almacenamiento](media-services-rest-storage-encryption.md)
...
### [Usar socios toodeliver Widevine tooMedia servicios de licencias](media-services-licenses-partner-integration.md)
#### [Usar Axinom Services de tooMedia de licencias de Widevine toodeliver](media-services-axinom-integration.md)
#### [Usar castLabs Services de tooMedia de licencias de Widevine toodeliver](media-services-castlabs-integration.md)
...
### [Analizar archivos multimedia mediante el portal de Hola](media-services-portal-analyze.md)
...
### [Insertar anuncios en el lado del cliente de Hola](media-services-inserting-ads-on-client-side.md)
### [Licencias del kit de portabilidad de cliente de Microsoft Smooth Streaming](media-services-sspk.md)
### [Reproducción de HLS con cifrado AES en Safari](https://azure.microsoft.com/blog/how-to-make-token-authorized-aes-encrypted-hls-stream-working-in-safari/)
...
## [PowerShell (administración de servicios)](/powershell/module/azure/?view=azuresmps-3.7.0)
