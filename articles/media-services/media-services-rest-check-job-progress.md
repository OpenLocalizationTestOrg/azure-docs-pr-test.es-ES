...
Cuando se ejecutan trabajos, a menudo requieren un progreso del trabajo de manera tootrack. Puede averiguar el estado del trabajo de hello mediante el uso de la propiedad de estado del trabajo de Hola. Para obtener más información sobre la propiedad State de hello, consulte [propiedades de la entidad de trabajo](https://docs.microsoft.com/rest/api/media/operations/job#job_entity_properties).
