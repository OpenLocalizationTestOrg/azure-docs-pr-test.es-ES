...
Este tema describe los pasos generales que puede llevar a cabo al configurar la telemetría de servicios de multimedia de Azure (AMS) hello mediante API de REST. 
...
pasos de Hello descritos en este tema son:

- Obtener la cuenta de almacenamiento de hello asociada a una cuenta de servicios multimedia
- Obtener puntos de conexión de notificación de Hola
- Crear un punto de conexión de notificación para la supervisión 

    toocreate un extremo de notificación, establecer hello EndPointType tooAzureTable (2) y la tabla de almacenamiento de toohello endPontAddress conjunto (por ejemplo, https://telemetryvalidationstore.table.core.windows.net/).
  
- Obtener configuración de supervisión de Hola
...
## <a name="get-hello-storage-account-associated-with-a-media-services-account"></a>Obtener la cuenta de almacenamiento de hello asociada a una cuenta de servicios multimedia
...
## <a name="get-hello-notification-endpoints"></a>Obtener los extremos de notificación de Hola
...
>[!NOTE]
>No olvide la cuenta de almacenamiento de toochange Hola "https://telemetryvalidationstore.table.core.windows.net" valor tooyour.
...
## <a name="get-hello-monitoring-configurations"></a>Obtener configuración de supervisión de Hola
