...
** Ruta de acceso de la copia impresa a los archivos de modelo que se usará en el Bloc de notas de consumo. ** Para consumir y puntuación de un conjunto de datos independiente, debe copiar y pegar estos nombres de archivo en el "Bloc de notas de consumo".
