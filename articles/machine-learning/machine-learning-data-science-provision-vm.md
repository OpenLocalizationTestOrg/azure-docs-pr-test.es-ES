...
Hemos empaquetado varios notebooks de ejemplo en Python y en R. Los notebooks de Jupyter muestran cómo trabajar con Microsoft R Server, SQL Server 2016 R Services (análisis en bases de datos), Python, Microsoft Cognitive ToolKit (CNTK) para un aprendizaje en profundidad y otras tecnologías de Azure una vez que inicie sesión en Jupyter. Puede ver el vínculo a los ejemplos en la página de inicio del notebook después de que se autentique en Jupyter Notebook con la contraseña creada en el paso anterior. 
