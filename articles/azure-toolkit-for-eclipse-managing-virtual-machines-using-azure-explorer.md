...
---
# <a name="manage-virtual-machines-by-using-hello-azure-explorer-for-eclipse"></a>Administrar máquinas virtuales mediante el uso de hello Azure Explorer para Eclipse

Hola Explorador de Azure, que forma parte de hello Azure Toolkit for Eclipse, proporciona a los desarrolladores de Java con una solución fácil de usar para administrar máquinas virtuales en su cuenta de Azure desde dentro del entorno de desarrollo integrado Eclipse hello (IDE).
...
4. Hola **seleccionar una imagen de máquina Virtual** ventana, escriba Hola siguiente información:
   ...
   * **Publisher**: especifica el publicador de Hola que creó la imagen de hello usará toocreate la máquina virtual (por ejemplo, *Microsoft*).
...
8. Hola **crear nueva cuenta de almacenamiento** ventana, escriba Hola siguiente información:
   ...
   * **Grupo de recursos**: especifica el grupo de recursos de hello para la máquina virtual. Seleccione una de las siguientes opciones de hello:
      ...
      * **Usar existente**: Especifica que desea tooselect un grupo de recursos que ya está asociado a su cuenta de Azure.

      ![cuadro de diálogo Crear nueva cuenta de almacenamiento de Hola][CR05]

   * **Cuenta de almacenamiento**: especifica hello toouse de cuenta de almacenamiento para almacenar la máquina virtual. Puede usar una cuenta de almacenamiento existente o crear una nueva.

   * **Red virtual** y **subred**: especifica la red virtual de Hola y de las subredes que se conectará la máquina virtual. Puede usar una red y subred existentes, o puede crear una nueva red y subred. Si selecciona **crear nuevo**, Hola después el cuadro de diálogo se muestra:

      ![cuadro de diálogo Crear nueva red Virtual de Hola][CR06]

9. Hola **recursos asociados** ventana, escriba Hola siguiente información:
   ...
   * **Conjunto de disponibilidad**: especifica un conjunto de disponibilidad opcional al que puede pertenecer su máquina virtual. Puede seleccionar un conjunto de disponibilidad existente o crear un nuevo conjunto de disponibilidad o, si la máquina virtual no pertenecerá tooan conjunto de disponibilidad, puede seleccionar **(ninguno)**.

   ![ventana de Hello recursos asociados][CR07]

9. Haga clic en **Finalizar**  
  La nueva máquina virtual se muestra en la ventana de herramientas del explorador de Azure de Hola.

   ![Nueva máquina virtual][CR08]

## <a name="restart-a-virtual-machine-in-eclipse"></a>Reinicio de una máquina virtual en Eclipse

toorestart una máquina virtual mediante el uso de hello Explorador de Azure en Eclipse, Hola siguientes:
...
tooshut hacia abajo una máquina virtual en ejecución mediante el uso de hello Explorador de Azure en Eclipse, Hola siguientes:
...
toodelete una máquina virtual mediante el uso de hello Explorador de Azure en Eclipse, Hola siguientes:
