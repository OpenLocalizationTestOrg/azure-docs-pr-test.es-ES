...
Vamos a usar la API de uso para rellenar la hoja *UsageAPI* y correlacionar la información con los datos de consumo de la API de facturación en la hoja *PublishData*.
...
El siguiente paso es crear una tabla de búsqueda que asocie la información de las etiquetas al campo *ResourceGroupName*. Esta tabla de búsqueda se utilizará en el paso siguiente para enriquecer los datos de consumo con información de etiqueta.
