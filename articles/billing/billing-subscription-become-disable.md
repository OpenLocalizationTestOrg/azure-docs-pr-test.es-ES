...
Para quitar el límite de gasto,
...
| Opción | Efecto |
| --- | --- |
| Quitar el límite de gasto indefinidamente |Quita el límite de gasto hasta que lo vuelva a activar. |
| Quitar el límite de gasto para el período de facturación actual |Quita el límite de gasto, pero dicho límite se reinicia para el siguiente período de facturación. |
...
![Capture la pantalla que muestra los vínculos de reactivación en el panel derecho.](./media/billing-how-to-cancel-azure-subscription/reactivate-sub.png)
