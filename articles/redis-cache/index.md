---
title: "aaaAzure documentación de caché Redis - tutoriales, referencia de API | Documentos de Microsoft"
description: "Obtenga información acerca de cómo toouse caché en Redis de Azure, una memoria caché de datos segura y de agente de mensajería que ofrece rápido a las aplicaciones tener acceso a toodata. Tutoriales, referencias de API y mucho más."
...
Obtenga información acerca de cómo toouse Azure Redis Cache, una memoria caché de datos segura y de agente de mensajería que proporciona un alto rendimiento y baja latencia acceso toodata para las aplicaciones. Tutoriales, referencias de API y otra documentación mostrarle cómo toouse caché en Redis desde cualquier aplicación en Azure.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Información acerca del nivel Premium de Azure Redis Cache</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos de Azure Redis Cache</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Empezar a trabajar con Redis Cache mediante .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Empezar a trabajar con Redis Cache mediante ASP.NET MVC</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Empezar a trabajar con Redis Cache mediante Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Empezar a trabajar con Redis Cache mediante Java</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Empezar a trabajar con Redis Cache mediante Python</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="http://redis.io/commands#">Comandos de Redis</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/redis/">Referencia de API de REST</a></p>
                    </div>
                </div>
            </div>
        </div>
