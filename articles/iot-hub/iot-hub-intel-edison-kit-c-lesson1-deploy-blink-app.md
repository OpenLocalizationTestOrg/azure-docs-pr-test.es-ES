...
### <a name="install-hello-azure-iot-hub-sdk-on-edison"></a>Instalar hello Azure IoT Hub SDK en Edison
Instalar hello Azure IoT Hub SDK en Edison ejecutando Hola siguiente comando:

```bash
gulp install-tools
```

Esta tarea puede tardar un toocomplete mucho tiempo, dependiendo de la conexión de red. Se necesita toobe ejecutar una sola vez para uno Edison.
