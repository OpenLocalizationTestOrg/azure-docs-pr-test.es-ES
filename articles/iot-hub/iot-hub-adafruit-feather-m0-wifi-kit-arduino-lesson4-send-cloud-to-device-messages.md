...
* La placa de Arduino, configurada para su uso. Para obtener información sobre cómo configurar la placa Arduino, consulte [Configuración del dispositivo][configure-your-device].
