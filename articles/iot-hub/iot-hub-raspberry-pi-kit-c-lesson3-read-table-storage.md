...
Antes de iniciar este proceso, debe haber completado correctamente [ejecutar aplicación de ejemplo de Hola Azure parpadeo en frambuesa Pi 3](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md).
...
[Ejecutar un tooreceive de la aplicación de ejemplo en la nube al dispositivo mensajes](iot-hub-raspberry-pi-kit-c-lesson4-send-cloud-to-device-messages.md)
