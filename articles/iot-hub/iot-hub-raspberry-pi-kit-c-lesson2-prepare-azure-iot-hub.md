...
Cuando se usa el centro de IoT de hello Azure CLI tooadd Pi tooyour, servicio de hello genera una clave para tooauthenticate Pi con el servicio de Hola. Si tiene problemas, buscar soluciones en hello [página solución de problemas](iot-hub-raspberry-pi-kit-c-troubleshooting.md).
...
[Crear una aplicación de Azure de función y un centro de IoT de almacenamiento de Azure cuenta tooprocess y el almacén de mensajes](iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template.md).
