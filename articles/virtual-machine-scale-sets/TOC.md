...
# Introducción
## [Implementar una escala establecida en el portal de Hola](virtual-machine-scale-sets-portal-create.md)
...
## Implementación
### [Crear con el portal de Hola](virtual-machine-scale-sets-portal-create.md)
...
### [Convertir un disco administrado escala conjunto plantilla toouse](virtual-machine-scale-sets-convert-template-to-md.md)
...
### [Convertir un disco de toomanaged de plantilla](virtual-machine-scale-sets-convert-template-to-md.md)
