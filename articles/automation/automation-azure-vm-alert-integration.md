...
3. En la hoja **Configuración**, en la sección de supervisión, seleccione **Reglas de alerta**.
...
> [!NOTE]
> En esta versión puede elegir entre los tres runbooks que proporciona el servicio: reiniciar, detener o quitar (eliminar) la máquina virtual.  La capacidad para seleccionar otros runbooks o uno de sus propios runbooks estará disponible en próximas versiones.
> 
> 
...
Haga clic en **Aceptar** in the **Agregar una regla de alerta** y se creará la regla de alerta y se activará si la máquina virtual está en estado de ejecución.
