...
En septiembre de 2016, Microsoft publicó una característica con la que puede administrar varias direcciones IP virtuales mediante un [equilibrador de carga interno de Azure][load-balancer-multivip-overview]. Esta funcionalidad ya existe en el equilibrador de carga externo Azure Hola.
...
> [!NOTE]
> Esta característica solo está disponible en el modelo de implementación de hello Azure Resource Manager.
...
4. [Instalar la instancia de base de datos de hello][sap-ha-guide-9.2].  
 En este paso, va a instalar DBMS en un clúster WSFC específico.

5. [Instalar el segundo nodo de clúster hello][sap-ha-guide-9.3].  
