...
Este script crea una máquina Virtual de Azure ejecutando Windows Server 2016 y, a continuación, usa hello tooinstall de extensión de Script personalizado de Azure Máquina Virtual de IIS. Después de ejecutar el script de Hola, puede tener acceso a sitio Web IIS de hello predeterminado en la dirección IP pública de Hola de máquina virtual de Hola.
