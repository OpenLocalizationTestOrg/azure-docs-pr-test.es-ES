...
Este script crea una máquina Virtual de Azure y, a continuación, usa Hola extensión de Script personalizado de Azure Virtual Machine tooinstall NGINX. Después de ejecutar el script de Hola, puede tener acceso a un sitio Web de demostración de la dirección IP pública de Hola de máquina virtual de Hola.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Agregar una máquina virtual VM extensión toohello. En este ejemplo, la extensión de script personalizado de hello es usado tooinstall NGINX. |
