...
Este script crea una máquina virtual de Azure donde se ejecuta Windows Server 2016. Después de ejecutar el script de Hola, puede tener acceso a máquina virtual de Hola a través de RDP.
