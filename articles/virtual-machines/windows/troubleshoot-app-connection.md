...
---
# <a name="troubleshoot-access-to-an-application-running-on-a-windows-virtual-machine-in-azure"></a><span data-ttu-id="13854-103">Solución de problemas de acceso a una aplicación que se ejecuta en una máquina virtual Windows en Azure</span><span class="sxs-lookup"><span data-stu-id="13854-103">Troubleshoot access to an application running on a Windows virtual machine in Azure</span></span>
