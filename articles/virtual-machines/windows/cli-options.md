...
Cuando se usa Docker para Windows, se puede iniciar una imagen de Docker que incluye la CLI de Azure. Esta imagen se basa en Linux e incluye una experiencia de Bash nativa.  Cuando se usa Docker para Windows y la imagen de la CLI de Azure, los scripts deben compartirse entre macOS, Linux y Windows. 
