...
---
# <a name="how-tooexpand-hello-os-drive-of-a-virtual-machine-in-an-azure-resource-group"></a><span data-ttu-id="4e840-103">¿Cómo tooexpand Hola unidad de sistema operativo de una máquina Virtual en un grupo de recursos de Azure</span><span class="sxs-lookup"><span data-stu-id="4e840-103">How tooexpand hello OS drive of a Virtual Machine in an Azure Resource Group</span></span>
