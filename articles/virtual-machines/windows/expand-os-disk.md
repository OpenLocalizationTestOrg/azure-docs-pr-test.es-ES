...
---
# <a name="how-to-expand-the-os-drive-of-a-virtual-machine-in-an-azure-resource-group"></a><span data-ttu-id="dd24a-103">Cómo ampliar la unidad de sistema operativo de una máquina virtual en un grupo de recursos de Azure</span><span class="sxs-lookup"><span data-stu-id="dd24a-103">How to expand the OS drive of a Virtual Machine in an Azure Resource Group</span></span>
