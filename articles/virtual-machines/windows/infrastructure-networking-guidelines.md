...
Porque no se conectan red local de tooyour, redes virtuales solo Azure pueden utilizar cualquier parte del espacio de direcciones IP privadas hello, incluso si hello es el mismo espacio privado en utilizar local.

### <a name="cross-premises-virtual-networks"></a>Redes virtuales entre locales
Si los equipos y usuarios locales requieren tooVMs de conectividad en curso en una red virtual de Azure, crear una red virtual entre entornos.  Conéctelo red de tooyour local con una ExpressRoute o una conexión de VPN de sitio a sitio.
...
Al igual que con una infraestructura de red física local, las redes virtuales de Azure pueden contener más elementos, aparte de las subredes y direcciones IP. Al diseñar la infraestructura de aplicación, puede que desee tooincorporate algunos de estos componentes adicionales:
