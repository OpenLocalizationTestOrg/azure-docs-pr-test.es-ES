...
Al diseñar la infraestructura de aplicación, planee los niveles de aplicación Hola que usar. Máquinas virtuales del grupo que actuar Hola mismo propósito en conjuntos de tooavailability, como un conjunto de disponibilidad para las máquinas virtuales front-end que ejecuta IIS. Cree un conjunto de disponibilidad independiente para las máquinas virtuales de back-end que ejecutan SQL Server. objetivo de Hello es tooensure que cada componente de la aplicación está protegido por un conjunto de disponibilidad y al menos una vez instancia siempre sigue ejecutándose.
