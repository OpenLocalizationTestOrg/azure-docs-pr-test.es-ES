...
Para consultar configuraciones de ejemplo para extensiones de Linux, haga clic en la documentación [Ejemplos de extensiones de Linux](extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
