...
---
# <a name="automating-application-deployments-toolinux-virtual-machines"></a>Automatizar las implementaciones de aplicación tooLinux máquinas virtuales 
...
plantilla de administrador de recursos del almacén de música de Hello puede encontrarse aquí, [plantilla de Linux de tienda de música](https://github.com/neilpeterson/nepeters-azure-templates/tree/master/dotnet-core-music-linux-vm-sql-db)
...
| --- | --- |
| SSHKEYDATA |Datos de la clave SSH utilizan toosecure acceso toohello Máquina Virtual. Para obtener información sobre cómo crear un par de claves SSH, consulte [Creación de claves SSH para máquinas virtuales Linux en Azure](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). |
...
| SQLADMINPASSWORD |Contraseña que se usa en hello base de datos de SQL Azure. |
