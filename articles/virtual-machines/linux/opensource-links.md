...
* [Preguntas más frecuentes sobre Máquinas virtuales de Azure con el modelo de implementación clásica](classic/faq.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Inicio de sesión en una máquina virtual de Linux con el Portal de Azure clásico](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

## <a name="set-up"></a>Instalación
* [Instalación de la CLI de Azure](../../cli-install-nodejs.md)

## <a name="tutorials"></a>Tutoriales
* [Instalación de la pila LAMP en una máquina virtual con Linux en Azure](create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Uso de la extensión de la máquina virtual de Docker desde la interfaz de la línea de comandos de Azure (CLI de Azure)](classic/cli-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Uso de la extensión de la máquina virtual de Docker con Azure Portal](classic/portal-use-docker.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [Cómo usar una máquina Docker en Azure](docker-machine.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Conceptos básicos: Captura de una máquina virtual de Linux para usar como plantilla](classic/capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [cómo restablecer una contraseña o las propiedades SSH de Linux](classic/reset-access.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
* [uso de la raíz](use-root-privileges.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)

## <a name="azure-resources"></a>Recursos de Azure.
* [el Agente de Linux de Azure](../windows/agent-user-guide.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [inserción de datos personalizados en una máquina virtual para su uso con Cloud-init](../windows/classic/inject-custom-data.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)

## <a name="storage"></a>Almacenamiento
* [asociación de un disco de datos a una máquina virtual Linux](../windows/classic/attach-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
...
* [Cómo configurar puntos de conexión de máquinas virtuales Linux clásicas en Azure](../windows/classic/setup-endpoints.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)

## <a name="troubleshooting"></a>Solución de problemas
* [Solución de problemas de conexiones de Secure Shell (SSH) en una máquina virtual de Azure basada en Linux](troubleshoot-ssh-connection.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
