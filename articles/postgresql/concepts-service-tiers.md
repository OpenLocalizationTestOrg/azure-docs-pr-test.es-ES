...
Cuando se crea una base de datos de Azure para servidor PostgreSQL, elija tres opciones principales recursos de hello tooconfigure asignados a dicho servidor. Estas opciones afectan al rendimiento de Hola y escala de servidor hello.
- Plan de tarifa 
- Unidades de proceso
- Almacenamiento (GB)
...
Dentro del servidor de Azure Database for PostgreSQL, puede tener una o varias bases de datos. Puede participar una base de datos por servidor tooutilize toocreate todos los recursos de Hola o crear tooshare de bases de datos de varios recursos de Hola. 
...
Cuando se crea una nueva base de datos de Azure para PostgreSQL dentro de hello [Portal de Azure](https://portal.azure.com/#create/Microsoft.PostgreSQLServer), haga clic en hello **tarifa** hello costo mensual y hoja se mostrará según en Opciones de Hola que ha seleccionado. Si no tiene una suscripción de Azure, use hello tooget de calculadora de precios Azure un precio estimado. Visite hello [Calculadora de precios de Azure](https://azure.microsoft.com/pricing/calculator/) de sitio Web, a continuación, haga clic en **agregar elementos**, expanda hello **bases de datos** categoría y elija **base de datos de Azure para PostgreSQL** opciones de hello toocustomize.

## <a name="choose-a-performance-level-compute-units"></a>Selección de un nivel de rendimiento (unidades de proceso)
Una vez haya determinado Hola tarifa para la base de datos de Azure para servidor PostgreSQL, son nivel de rendimiento de hello toodetermine listo seleccionando Hola número de unidades de proceso sea necesario. Un buen punto de partida son 200 o 400 unidades de proceso para aplicaciones que necesiten más simultaneidad de usuarios para las cargas de trabajo web o analíticas. Esta cantidad se puede incrementar en función de las necesidades correspondientes. 
...
configuración de almacenamiento de Hello define la cantidad de Hola de almacenamiento capacidad disponible tooan base de datos de Azure para servidor de PostgreSQL. almacenamiento de Hello utilizado por el servicio de hello incluye archivos de base de datos de hello, registros de transacciones y registros de servidor hello PostgreSQL. Considere la posibilidad de tamaño de Hola de almacenamiento necesario toohost las bases de datos y Hola requisitos de rendimiento (IOPS) al seleccionar la configuración de almacenamiento de Hola.
...
Inicialmente, elegir Hola precios nivel y el rendimiento cuando se crea la base de datos de Azure para PostgreSQL. Más adelante, puede escalar Hola unidades calcular una copia de seguridad o dinámicamente, abajo dentro del alcance de Hola de Hola mismo nivel de precios. Hola portal de Azure, deslice Hola proceso unidades en la hoja de nivel de precios del servidor de Hola o escribirlo siguiendo este ejemplo: [Monitor y escala un único servidor de PostgreSQL con CLI de Azure](scripts/sample-scale-server-up-or-down.md)
...
- Obtenga información acerca de cómo demasiado[Monitor y escala un único servidor de PostgreSQL con CLI de Azure](scripts/sample-scale-server-up-or-down.md)
