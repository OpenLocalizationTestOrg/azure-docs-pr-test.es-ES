...
En el trabajo de servicio de nube de Hola o archivo de definición de servicio de rol web, puede exponer los valores de configuración en tiempo de ejecución como variables de entorno. Hola después de los valores de XPath se admite (que corresponden a los valores de tooAPI).

Estos valores de XPath también están disponibles a través de hello [Microsoft.WindowsAzure.ServiceRuntime](https://msdn.microsoft.com/library/microsoft.windowsazure.serviceruntime.roleenvironment.aspx) biblioteca. 

## <a name="app-running-in-emulator"></a>Aplicación en ejecución en el emulador
Indica que la aplicación Hola se ejecuta en el emulador de Hola.
...
Recupera el identificador de implementación de hello para la instancia de Hola.
...
Recupera el identificador de rol actual de hello para la instancia de Hola.
...
Recupera el dominio de actualización de Hola de instancia de Hola.
...
Recupera el dominio de error de Hola de instancia de Hola.
...
Recupera el nombre de la función hello de instancias de Hola.
...
Recupera Hola valo Hola especifica valor de configuración.
...
Recupera la ruta de acceso de almacenamiento local de hello para la instancia de Hola.
...
Recupera el tamaño de Hola de almacenamiento local de hello para la instancia de Hola.
...
Recupera el protocolo de extremo de hello para la instancia de Hola.
...
Hola Obtiene la dirección IP del punto de conexión especificada.
...
Recupera el puerto de extremo de hello para la instancia de Hola.
...
Este es un ejemplo de un rol de trabajo que crea una tarea de inicio con una variable de entorno denominada `TestIsEmulated` establecer toohello [ @emulated valor xpath](#app-running-in-emulator). 
...
Obtener más información sobre hello [ServiceConfiguration.cscfg](cloud-services-model-and-package.md#serviceconfigurationcscfg) archivo.
