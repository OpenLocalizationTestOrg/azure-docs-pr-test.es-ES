...
Este ejemplo de C# muestra cómo toomanage hacen referencia a datos para un entorno de visión de serie de tiempo de Azure.
Antes de ejemplo Hola en ejecución, asegúrese de hello pasos completado.
1. Se ha creado un conjunto de datos de referencia con [este artículo](time-series-insights-add-reference-data-set.md).
2. token de acceso de Hello utilizado cuando se ejecuta la aplicación hello adquirida a través de Hola API de Azure Active Directory. Este token se debe pasar hello `Authorization` encabezado de cada solicitud de API de consulta. Para configurar las aplicaciones no interactivas, vea hello [autenticación y autorización](time-series-insights-authentication-and-authorization.md) artículo.
3. Todas las constantes de hello definidas en principio de Hola de ejemplo de Hola se han definido correctamente.
