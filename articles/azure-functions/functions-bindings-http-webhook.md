...
También puede enlazar a un mensaje POCO en lugar de `HttpRequestMessage`. Se recibirá desde el cuerpo de la solicitud, analizado como JSON. De forma similar, puede pasarse un tipo al enlace de la salida de respuesta HTTP y se devolverá como cuerpo de la respuesta, con el código de estado 200.
```csharp
using System.Net;
using System.Threading.Tasks;
