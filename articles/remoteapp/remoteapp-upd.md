...
> [!NOTE]
> ¿Necesidad de deshabilitar el UPD? Puede hacerlo ahora: compruebe la entrada de blog de Pavithra, [Deshabilitar discos de perfil de usuario (UPD) en Azure RemoteApp](https://blogs.technet.microsoft.com/enterprisemobility/2015/11/11/disable-user-profile-disks-upds-in-azure-remoteapp/), para más información.
> 
> 

## <a name="how-can-an-admin-get-to-the-data"></a>¿Cómo puede un administrador acceder a los datos?
...
## <a name="is-the-data-backed-up"></a>¿Se efectúa una copia de seguridad de los datos?
...
## <a name="how-do-users-see-the-upd-on-the-server-side"></a>¿Cómo ven los usuarios el UPD en el servidor?
Cada usuario tendrá su propio directorio en el servidor que se asigna a su UPD: c:\Users\username.

## <a name="whats-the-best-way-to-use-outlook-and-upd"></a>¿Cuál es la mejor manera de usar Outlook y UPD?
...
Sí, todo lo escrito en HKEY_Current_User forma parte de los UPD.
...
* No necesita ningún almacenamiento de datos local o tiene todos los datos en la nube o un recurso compartido de archivos y quiere controlar el almacenamiento local de datos con Azure RemoteApp.
...
## <a name="can-i-restrict-users-from-saving-data-to-the-system-drive"></a>¿Puedo impedir que los usuarios guardar los datos en la unidad del sistema?
...
## <a name="can-i-seed-upds-i-want-to-put-some-data-in-the-upd-thats-available-the-first-time-the-user-signs-in"></a>¿Se pueden propagar los UPD? Deseo colocar algunos datos en el UPD que está disponible la primera vez que el usuario inicia sesión.
...
## <a name="can-i-change-the-size-of-the-upd-depending-on-how-much-data-i-want-to-store"></a>¿Puedo cambiar el tamaño del UPD en función de la cantidad de datos que deseo almacenar?
...
## <a name="what-about-placing-a-startup-script-in-the-start-menu-would-that-work"></a>¿Qué sucede si se coloca un script de inicio en el menú Inicio? ¿Funcionaría?
