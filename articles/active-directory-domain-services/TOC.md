...
### [Tarea 1: crear el grupo de administradores de Hola](active-directory-ds-getting-started-create-group.md)
...
#### [Tarea 2: exportar certificado LDAP seguro de Hola](active-directory-ds-admin-guide-configure-secure-ldap-export-pfx.md)
#### [Tarea 3: habilitar LDAP seguro para hello dominio administrado mediante el portal de Azure clásico](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps-classic.md)
#### [Tarea 3: habilitar LDAP seguro para hello dominio administrado mediante el portal de Azure (vista previa)](active-directory-ds-admin-guide-configure-secure-ldap-enable-ldaps.md)
...
### [Habilitar la vista previa de hello Azure experiencia del portal](active-directory-ds-azure-portal-enable-preview-access.md)
