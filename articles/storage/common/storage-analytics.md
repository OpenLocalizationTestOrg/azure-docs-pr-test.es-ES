...
> [!NOTE]
> Actualmente, las métricas de capacidad solo están disponibles para el servicio Blob. Las métricas de capacidad para el servicio Tabla y el servicio Cola estarán disponibles en versiones futuras del análisis de almacenamiento.
> 
> 
