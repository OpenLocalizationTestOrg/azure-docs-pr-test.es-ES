...
Un escenario donde puedes toospecify un extremo explícito es cuando se ha asignado su tooa de punto de conexión de almacenamiento de blobs [dominio personalizado](../blobs/storage-custom-domain-name.md). En ese caso, puede especificar un punto de conexión personalizado para Blob Storage en la cadena de conexión. También puede especificar extremos predeterminados de Hola para hello otros servicios si la aplicación usa.
