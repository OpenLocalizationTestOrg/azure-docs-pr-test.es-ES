...
---
# <a name="what-happened-toomy-cloud-services-project-visual-studio-azure-storage-connected-service"></a>¿Qué servicios de nube toomy problema proyectos (servicio de Visual Studio de almacenamiento de Azure conectado)?
...
Se crea ningún elemento con la cadena de conexión y la clave de la cuenta de almacenamiento de hello seleccionado. Se han realizado modificaciones toohello siguientes archivos:
