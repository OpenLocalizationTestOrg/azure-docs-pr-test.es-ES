...
Hay de otros contenido de hello toolist de formas de un contenedor de blobs. Consulte [Introducción al Almacenamiento de blobs de Azure mediante .NET](storage-dotnet-how-to-use-blobs.md#list-the-blobs-in-a-container) para más información.
...
Hay otras maneras de BLOB toosave como archivos. Consulte [Introducción al Almacenamiento de blobs de Azure mediante .NET](storage-dotnet-how-to-use-blobs.md#download-blobs) para más información.
