...
tootest la aplicación en el equipo local basado en Windows, puede usar hello Azure [emulador de almacenamiento](storage-use-emulator.md) que se instala con hello [Azure SDK](https://azure.microsoft.com/downloads/). emulador de almacenamiento de Hello es una utilidad que simula los servicios de Azure Blob, cola y tabla de hello disponibles en el equipo de desarrollo local. Hello en el ejemplo siguiente se muestra cómo se puede declarar un emulador de almacenamiento local de campo estático toohold Hola conexión cadena tooyour:  
...
* [¿Cómo toouse almacenamiento de blobs de C++](storage-c-plus-plus-how-to-use-blobs.md)
