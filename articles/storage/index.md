        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Más información acerca de Azure Storage</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos de Azure Storage</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Creación de una cuenta de Storage</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/dotnet/api/microsoft.windowsazure.storage.datamovement">.NET: movimiento de datos</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/storageservices/azure-storage-services-rest-api-reference">Blobs, colas, tablas y archivos</a></p>
                        <p><a href="/rest/api/storagerp">Proveedor de recursos</a></p>
                        <p><a href="/rest/api/storageimportexport">Import/Export</a></p>
                        <p><a href="/rest/api/storageservices">API de REST de datos de almacenamiento</a></p>
                   </div>
                </div>
            </div>
        </div>
