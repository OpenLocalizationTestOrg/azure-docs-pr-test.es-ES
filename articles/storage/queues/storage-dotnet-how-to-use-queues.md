...
* Ver más características guías toolearn acerca de otras opciones para almacenar datos en Azure.
  * [Introducción al almacenamiento de tabla de Azure mediante .NET](../../cosmos-db/table-storage-how-to-use-dotnet.md) toostore datos estructurados.
  * [Introducción al almacenamiento de blobs de Azure mediante .NET](../blobs/storage-dotnet-how-to-use-blobs.md) toostore datos no estructurados.
  * [Conectar tooSQL base de datos mediante el uso de .NET (C#)](../../sql-database/sql-database-connect-query-dotnet-core.md) toostore de datos relacionales.
