...
* [Getting Started with Azure Blob Service in Java](storage-java-how-to-use-blob-storage.md) (Introducción a Blob service de Azure en Java)
* [Introducción al servicio Cola de Azure en .NET](storage-java-how-to-use-queue-storage.md)
* [Getting Started with Azure Table service in Java](storage-java-how-to-use-table-storage.md) (Introducción a Azure Table service en Java)
