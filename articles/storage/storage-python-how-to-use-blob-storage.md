...
En el ejemplo siguiente se muestra cómo usar **get\_blob\_to\_path** para descargar el contenido del blob **myblob** blob y almacenarlo en el archivo **out-sunset.png**.
