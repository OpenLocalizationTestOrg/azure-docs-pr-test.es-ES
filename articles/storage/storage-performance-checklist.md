...
Para ver un ejemplo de cómo obtener los metadatos de un blob mediante .NET, consulte [Establecer y recuperar propiedades y metadatos](storage-properties-metadata.md).  
...
Para obtener más información, consulte [Cambio del contenido de un mensaje en cola](storage-dotnet-how-to-use-queues.md#change-the-contents-of-a-queued-message).  
