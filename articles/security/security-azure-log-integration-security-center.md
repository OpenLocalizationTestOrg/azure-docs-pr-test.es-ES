...
2. Después ejecutará un comando que asigna acceso de lectura en la suscripción a la entidad de servicio creada en el paso 2. Si no especifica un SubscriptionID, entonces el comando intenta asignar el rol de lector de la entidad de servicio a todas las suscripciones a las que tiene acceso. </br></br>
