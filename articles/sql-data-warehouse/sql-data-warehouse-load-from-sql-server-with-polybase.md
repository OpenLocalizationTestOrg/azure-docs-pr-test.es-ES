...
Este tutorial se muestra cómo datos tooload en almacenamiento de datos de SQL mediante el uso de AzCopy y PolyBase. Cuando termine, sabrá cómo:
...
Vea también [Getting Started with Hola utilidad de línea de comandos de AzCopy][latest version of AzCopy].
