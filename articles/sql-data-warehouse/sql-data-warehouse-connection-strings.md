...
Puede conectar tooSQL almacenamiento de datos con varios protocolos de aplicación diferente como, [ADO.NET][ADO.NET], [ODBC][ODBC], [PHP] [ PHP] y [JDBC][JDBC]. A continuación se muestran algunos ejemplos de cadenas de conexión para cada protocolo.  También puede utilizar hello toobuild portal Azure de la cadena de conexión.  toobuild la cadena de conexión mediante Hola portal de Azure, navegue en hoja de la base de datos de tooyour, *Essentials* haga clic en *mostrar cadenas de conexión de base de datos*.
...
> [!NOTE]
> Considere la posibilidad de configuración Hola conexión tiempo de espera too300 segundos en orden tooallow Hola conexión toosurvive breves períodos de falta de disponibilidad.
> 
> 
