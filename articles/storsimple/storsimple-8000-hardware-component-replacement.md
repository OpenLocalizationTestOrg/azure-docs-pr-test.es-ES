...
|:--- |:--- |:--- |:--- |
| Chasis |1 |No |[Reemplazar el chasis de hello en el dispositivo StorSimple](storsimple-8000-chassis-replacement.md) |
...
| Batería de reserva |2 |Sí |[Reemplazar el módulo de batería de reserva de hello en el dispositivo StorSimple](storsimple-8000-battery-replacement.md) |
...
Por favor, [póngase en contacto con Microsoft Support](storsimple-8000-contact-microsoft-support.md) tooorder cualquiera de estas unidades de sustitución.
