...
---
# <a name="use-hello-storsimple-manager-service-toomanage-backup-policies-update-2"></a>Usar directivas de copia de seguridad servicio toomanage StorSimple Manager de hello (actualización 2)
...
## <a name="hello-backup-policies-page"></a>página de directivas de copia de seguridad de Hola
Hola **directivas de copia de seguridad** página permite las directivas de copia de seguridad de toomanage y programación local y en la nube. (Las directivas de copia de seguridad son programaciones de copia de seguridad de tooconfigure usado y retención de copia de seguridad de un conjunto de volúmenes). Directivas de copia de seguridad le permiten tootake una instantánea de varios volúmenes simultáneamente. Esto significa que las copias de seguridad de hello creados por una directiva de copia de seguridad estará copias coherente para bloqueos. Hola **directivas de copia de seguridad** página enumera las directivas de copia de seguridad de hello, sus tipos, volúmenes Hola asociado, número de Hola de copias de seguridad retenidas y Hola opción tooenable estas directivas.
...
* **Nombre de la directiva** : hello nombre asociado con la directiva de Hola. Hola distintos tipos de directivas incluyen:
  ...
  * Directivas automáticas, que se crean cuando se habilitó la copia de seguridad de hello predeterminado para esta opción de volumen en tiempo de Hola para crear un volumen. Estas directivas se denominan *VolumeName*_Default donde *VolumeName* hace referencia el nombre de toohello de hello volumen de StorSimple configurado por el usuario de Hola Hola portal de Azure clásico. directivas automáticas Hola dar lugar a instantáneas diarias en la nube empezando por hora del dispositivo 22:30.
