...
Puede conectarse de forma remota dispositivos tooyour mediante Windows PowerShell. Cuando se conecta de este modo, no ve un menú. (Verá un menú solo si usa la consola serie de hello en hello dispositivo tooconnect). Con la comunicación remota de Windows PowerShell, conecte tooa espacio de ejecución específica. También puede especificar el idioma para mostrar hello.

Para obtener más información acerca del uso de Windows PowerShell remoting toomanage el dispositivo, vaya demasiado[usar Windows PowerShell para StorSimple tooadminister dispositivo StorSimple](storsimple-8000-windows-powershell-administration.md).

Este tutorial le explica cómo tooconfigure el dispositivo para la administración remota y, a continuación, cómo tooconnect tooWindows PowerShell para StorSimple. Puede utilizar HTTP o HTTPS tooremotely conectarse mediante Windows PowerShell. Sin embargo, cuando decida cómo tooconnect tooWindows PowerShell para StorSimple, considere la posibilidad de hello siguiente información:
...
Puede usar cualquier hello Azure portal o hello consola serie tooconfigure administración remota. Seleccione una de hello procedimientos siguientes:

* [Utilizar la administración remota de tooenable portal Azure de Hola a través de HTTP](#use-the-azure-classic-portal-to-enable-remote-management-over-http)
...
### <a name="use-hello-azure-portal-tooenable-remote-management-over-http"></a>Utilizar la administración remota de tooenable portal Azure de Hola a través de HTTP

Realizar Hola siguiendo los pasos en la administración remota de hello Azure tooenable portal a través de HTTP.

#### <a name="tooenable-remote-management-through-hello-azure-portal"></a>administración remota de tooenable a través de hello portal de Azure

1. Servicio de administrador de dispositivos de StorSimple de tooyour go. Seleccione **dispositivos** y, a continuación, seleccione y haga clic en el dispositivo de hello desea tooconfigure para la administración remota. Vaya demasiado**configuración del dispositivo > seguridad**.
2. Hola **configuración de seguridad** hoja, haga clic en **administración remota**.
3. Hola **administración remota** hoja, establezca **habilitar la administración remota** demasiado**Sí**.
...
* [Utilizar la administración remota de tooenable portal Azure de Hola a través de HTTPS](#use-the-azure-classic-portal-to-enable-remote-management-over-https)
...
### <a name="use-hello-azure-portal-tooenable-remote-management-over-https"></a>Utilizar la administración remota de tooenable portal Azure de Hola a través de HTTPS

Realizar Hola siguiendo los pasos en la administración remota de hello Azure tooenable portal a través de HTTPS.

#### <a name="tooenable-remote-management-over-https-from-hello-azure-portal"></a>tooenable la administración remota a través de HTTPS de hello portal de Azure
...
5. Haga clic en ... y, después, en **Descargar certificado de administración remota**. Especifique una ubicación toosave este archivo. Necesita tooinstall este certificado en el equipo cliente o host Hola que va a usar tooconnect toohello dispositivo.
...
Cada uno de hello anteriores procedimientos, se describe a continuación.

#### <a name="tooimport-hello-certificate-on-hello-remote-host"></a>certificado de hello tooimport en host remoto hello
1. Haga clic en el archivo .cer de hello y seleccione **instalar certificado**. Esto inicia Hola Asistente para importación de certificados.
...
Usar Windows PowerShell y SSL tooenter una sesión de SSAdmin en el dispositivo desde un cliente o host remoto. sesión de SSAdmin Hola asigna toooption 1 Hola [consola serie](storsimple-8000-windows-powershell-administration.md#connect-to-windows-powershell-for-storsimple-via-the-device-serial-console) menú del dispositivo.
...
2. Agregar hosts de confianza del cliente de hello dispositivo IP dirección toohello, escriba:
    ...
    Donde <*device_ip*> Hola dirección de IP del dispositivo; por ejemplo: 
     ...
     `Set-Item wsman:\localhost\Client\TrustedHosts 10.126.173.90 -Concatenate -Force`
3. toocreate una nueva credencial, escriba:
...
* Obtenga más información sobre [mediante Windows PowerShell tooadminister dispositivo StorSimple](storsimple-8000-windows-powershell-administration.md).
