...
secciones de Hello siguientes tratarán los componentes estándar que normalmente se encuentran en estas zonas.
...
Microsoft usa framework Hola descrita anteriormente toodo amenazas de IoT de Azure. En la siguiente sección de Hola, por tanto, usamos ejemplo concreto de Hola de toodemonstrate de arquitectura de referencia de IoT de Azure cómo identifica toothink acerca de IoT y cómo tooaddress Hola amenazas de modelado de amenazas. En este caso, se han identificado cuatro áreas principales de atención:
...
toolearn más acerca de cómo proteger la solución de IoT, consulte [proteger la implementación de IoT][lnk-security-deployment].
