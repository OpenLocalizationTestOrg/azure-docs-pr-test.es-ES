...
Soluciones de ejemplo que realizan operaciones CRUD y otras operaciones comunes en los recursos de base de datos de Azure Cosmos se incluyen en hello [azure-documentdb-nodejs](https://github.com/Azure/azure-documentdb-node/tree/master/samples) repositorio de GitHub. Este artículo ofrece:

* Tareas de toohello de vínculos en cada uno de los archivos de proyecto de ejemplo de Hola Node.js.
* Toohello de vínculos relacionados con contenido de referencia de API.

**Requisitos previos**

1. Necesita una cuenta de Azure toouse estos ejemplos de Node.js:
...
2. También necesita hello [SDK de Node.js](documentdb-sdk-node.md).
   
   > [!NOTE]
   > Cada ejemplo es independiente, es decir, se configura a sí mismo y posteriormente se limpia solo. Por lo tanto, los ejemplos de hello emiten varias llamadas demasiado[DocumentClient.createCollection](http://azure.github.io/azure-documentdb-node/DocumentClient.html#createCollection). Cada vez que esto se realiza la suscripción le facturará una hora de uso por nivel de rendimiento de Hola de colección de Hola que se está creando.
   > 
   > 

## <a name="database-examples"></a>Ejemplos de base de datos
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/DatabaseManagement/app.js) archivo de hello [DatabaseManagement](https://github.com/Azure/azure-documentdb-node/tree/master/samples/DatabaseManagement) proyecto muestra cómo hello tooperform después de las tareas.
...
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/CollectionManagement/app.js) archivo de hello [CollectionManagement](https://github.com/Azure/azure-documentdb-node/tree/master/samples/CollectionManagement) proyecto muestra cómo hello tooperform después de las tareas.
...
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/DocumentManagement/app.js) archivo de hello [DocumentManagement](https://github.com/Azure/azure-documentdb-node/tree/master/samples/DocumentManagement) proyecto muestra cómo hello tooperform después de las tareas.
...
| [Documento de Hola de lectura para una colección de fuentes de distribución](https://github.com/Azure/azure-documentdb-node/blob/ef53e5f6707a5dc45920fb6ad54d9c7e008a6c18/samples/DocumentDB.Samples.DocumentManagement/app.js#L179-L189) |[DocumentClient.readDocument](http://azure.github.io/azure-documentdb-node/DocumentClient.html#readDocument) |
...
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/IndexManagement/app.js) archivo de hello [IndexManagement](https://github.com/Azure/azure-documentdb-node/tree/master/samples/IndexManagement) proyecto muestra cómo hello tooperform después de las tareas.
...
| [Excluir manualmente un documento específico desde el índice de Hola](https://github.com/Azure/azure-documentdb-node/blob/ef53e5f6707a5dc45920fb6ad54d9c7e008a6c18/samples/DocumentDB.Samples.IndexManagement/app.js#L120-L183) |[RequestOptions.indexingDirective: 'exclude'](http://azure.github.io/azure-documentdb-node/global.html#RequestOptions) |
...
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/ServerSideScripts/app.js) archivo de hello [ServerSideScripts](https://github.com/Azure/azure-documentdb-node/tree/master/samples/ServerSideScripts) proyecto muestra cómo hello tooperform después de las tareas.
...
Hola [app.js](https://github.com/Azure/azure-documentdb-node/blob/master/samples/Partitioning/app.js) archivo de hello [particiones](https://github.com/Azure/azure-documentdb-node/tree/master/samples/Partitioning) proyecto muestra cómo hello tooperform después de las tareas.
