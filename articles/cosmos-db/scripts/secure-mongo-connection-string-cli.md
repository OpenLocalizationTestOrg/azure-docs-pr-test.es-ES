...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-hello-azure-cli"></a>Obtener una cadena de conexión de base de datos de Azure Cosmos para las aplicaciones de MongoDB utilizando Hola CLI de Azure

En este ejemplo se obtiene una cadena de conexión de base de datos de Azure Cosmos para las aplicaciones de MongoDB con hello CLI de Azure. 
...
| [az cosmosdb list-connection-strings](https://docs.microsoft.com/cli/azure/cosmosdb#list-connection-strings) | Obtiene la cadena de conexión de hello para la cuenta de hello.|
