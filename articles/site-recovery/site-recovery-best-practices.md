...
**Requisito** | **Replicación de máquinas virtuales de VMware o servidores físicos en Azure** | * **Replicar servidores físicos o máquinas virtuales de VMware en el sitio secundario**  
---|---|---
