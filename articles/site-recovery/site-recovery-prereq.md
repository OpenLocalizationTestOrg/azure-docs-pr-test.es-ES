...
Configure una máquina local como el servidor de configuración para coordinar la comunicación entre el sitio local y Azure. La máquina local también administra la replicación de datos. <br/></br>
