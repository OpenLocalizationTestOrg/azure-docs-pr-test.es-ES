...
---
# <a name="step-1-review-hello-architecture-for-azure-vm-replication-between-azure-regions"></a>Paso 1: Revisar la arquitectura de hello para la replicación de máquina virtual de Azure entre regiones de Azure


Después de revisar hello [pasos generales](azure-to-azure-walkthrough-overview.md) para esta implementación, lea este componentes de artículo toounderstand hello y procesos que se utilizan cuando la replicación y recuperación de máquinas virtuales de Azure (VM) de tooanother de una región de Azure, usando [Azure Site Recovery](site-recovery-overview.md).

- Cuando termine de artículo hello, debe tener una idea clara de cómo funciona la región de tooanother de replicación de máquina virtual de Azure.
...
2. La replicación continua está configurada para hello máquina virtual. Escrituras de datos en hello VM discos estén continuamente transfieren toohello cuenta de almacenamiento de caché en la ubicación de origen de Hola.
  ...
  Tenga en cuenta que Site Recovery nunca necesita conectividad toohello VM de entrada. Solo salida direcciones TCP/IP direcciones URL de servicio de recuperación de tooSite de conectividad, direcciones de TCP/IP direcciones URL de autenticación de Office 365 y direcciones IP de cuenta de almacenamiento de caché es necesario. 
