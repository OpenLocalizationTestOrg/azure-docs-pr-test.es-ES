...
---
# <a name="step-5-prepare-azure-resources-for-vmware-replication-tooazure"></a>Paso 5: Preparar los recursos de Azure para tooAzure de replicación de VMWare


Utilice instrucciones de hello en este tooprepare artículo Azure recursos para que puedan replicar tooAzure de máquinas locales con hello [Azure Site Recovery](site-recovery-overview.md) servicio.
...
Asegúrese de que ha leído hello [requisitos previos](vmware-walkthrough-prerequisites.md)
...
Vaya demasiado[paso 6: recursos de VMware preparar.](vmware-walkthrough-prepare-vmware.md)
